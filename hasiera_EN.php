...
<body>
    ...
    <div class="sticky">
        <div class="navbar">
            <div class="left">
                <a class="left active" href="hasiera_EN.html">Home</a>
    ...
    <div class="imagenes">
        <div class="imagen" id="imagen1">
            <a href="katalogoaOrdenagailuak_EN.html" class="irudiak">
        ...
        <div class="imagen" id="imagen2">
            <a href="katalogoaMugikorrak_EN.html" class="irudiak">
        ...
        <div class="imagen" id="imagen3">
            <a href="katalogoaMonitoreak_EN.html" class="irudiak">
        ...
        <div class="imagen" id="imagen4">
            <a href="katalogoaAurikularrak_EN.html" class="irudiak">
    ...
    <div class="albisteak">
        ...
        <div class="izenburua1">
            <h2>12% of Entities in the Basque Country Use Artificial Intelligence, an Emerging Field in the Region</h2>
        </div>
        ...
        <div class="albistea1">
            <p>In the Autonomous Community of the Basque Country (EAE), 12.2% of entities use Artificial Intelligence
            ...
            <p>According to the report, the Basque Country is above the national average, with AI usage comparable to
            ...
            <p>Industry Minister Mikel Jauregi has emphasized that AI represents a "historic revolution" and positions
    ...
    <div class="albisteak">
        ...
        <div class="laburpena2">
            <h5>We got to know Tecnalia's newest robots at the research center's headquarters in the Gipuzkoa Science
        ...
        <div class="albistea2">
            ...
            <p>"We’ve made great strides in recent years," Esnaola explained, "and we’re in a very good position in the
